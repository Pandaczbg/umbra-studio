    ...
    <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
      ...
      <section className="relative min-h-[100svh] overflow-hidden">
        <Image
          ...
          priority
          sizes="100vw"
          className="scale-[1.03] object-cover opacity-[0.54]"
        />
          ...
          <div className="grid gap-16 lg:grid-cols-[260px_1fr]">
            ...
            <div className="max-w-[900px]">
              ...
              <p className="mt-9 max-w-[760px] text-[15px] leading-8 text-white/40">
                The project is developed around character,
                atmosphere and the visual interpretation of its
                source material. Umbra Studio approaches each
                story as a cinematic world where narrative,
                frame and motion work as one.
              </p>
