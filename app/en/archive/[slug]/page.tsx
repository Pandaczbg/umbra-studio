...
export async function generateMetadata(
  ...
  if (!entry) {
    return createPageMetadata("en", {
      ...
      description: "Umbra Studio archive.",
      pathname: `/en/archive/${params.slug}`,
    });
  }

  return createPageMetadata("en", {
    title: `${entry.title.en} — Umbra Studio`,
    description:
      entry.description?.en ?? "Umbra Studio archive entry.",
    pathname: `/en/archive/${entry.id}`,
  });
}
      ...
      <section className="relative overflow-hidden border-b border-white/[0.055]">
        ...
        <div className="relative z-10 mx-auto max-w-[1560px] px-5 pb-20 pt-20 sm:px-8 sm:pb-24 sm:pt-24 lg:px-14 lg:pb-32 lg:pt-28">
          <div className="flex items-center justify-between border-b border-white/[0.055] pb-5">
            <Link
              href="/en/archive"
              className="group inline-flex min-h-10 items-center gap-3 font-mono text-[6px] uppercase tracking-[0.26em] text-white/[0.28] transition-colors duration-300 hover:text-white/[0.64] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#ead39a]/45"
            >
              <ArrowLeft
                aria-hidden="true"
                size={13}
          ...
          <div className="grid gap-px overflow-hidden border border-white/[0.07] bg-white/[0.07] lg:grid-cols-[0.68fr_1.32fr]">
            <aside className="relative bg-[#060606] p-6 sm:p-8 lg:p-10">
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, rgba(199,169,107,.22), transparent)",
                }}
              />
            ...
            <article className="relative bg-[#070707] p-6 sm:p-8 lg:p-12">
              ...
              <div className="mt-8 max-w-[820px] border-l border-white/[0.07] pl-6 sm:pl-8">
                <p className="text-[13px] leading-7 text-white/[0.4] sm:text-[14px] sm:leading-8">
                  {entry.description?.en ??
                    "Detailed information for this archive entry has not been published yet."}
                </p>
              </div>
