        ...
        <div className="relative z-10 mx-auto max-w-[1500px] px-6 py-24 sm:px-10 sm:py-28 lg:px-16 lg:py-36">
          ...
          <div className="mt-16 max-w-[980px]">
            ...
            <p className="mt-7 max-w-[680px] text-[14px] leading-7 text-white/[0.40] sm:text-[15px] sm:leading-8">
              The archive preserves development
              traces, material and content belonging
              to the Umbra universe without placing
              it inside the main navigation.
            </p>
          </div>
        </div>
      </section>
            ...
            {entries.map(
              (entry) => (
                <Link
                  ...
                  className="group block bg-[#060606] transition-colors duration-300 hover:bg-[#080808]"
                >
                  <article className="h-full p-6">
                    <div className="flex items-start justify-between gap-5">
                      ...
                      <ArrowUpRight
                        ...
                        size={13}
                        strokeWidth={1.1}
                        className="shrink-0 text-[#ead39a]/35 transition-[color,transform] duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[#ead39a]/75"
                      />
                    </div>

                    <h3 className="mt-4 text-xl font-[430] uppercase leading-[0.92] tracking-[-0.04em] text-white transition-colors duration-300 group-hover:text-white/[0.92]">
                      {entry.title.en}
                    </h3>
                    ...
                    <div
                      aria-hidden="true"
                      className="mt-7 h-px w-10 transition-[width] duration-300 group-hover:w-16"
                      style={{
                        background:
          ...
          >
            <div className="max-w-[680px]">
              ...
              <h3 className="mt-4 text-[clamp(1.8rem,3.5vw,3.2rem)] font-[430] uppercase leading-[0.9] tracking-[-0.055em] text-white/[0.92]">
                The archive is not open yet
              </h3>

              <p className="mt-5 max-w-[560px] text-[13px] leading-7 text-white/[0.34]">
                Canonical archive content has not
                been published yet. When it is ready,
                it will appear here without changing
                the page structure.
              </p>
            </div>
          </div>
