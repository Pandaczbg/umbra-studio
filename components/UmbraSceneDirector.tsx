  ...
  useEffect(() => {
    ...
    const publishScene =
      (
        ...
        root.dataset.umbraSceneDirection =
          direction;
    ...
    /*
     * Important:
     * The first evaluation happens after layout has settled.
     * This makes the initial scene and active navigation deterministic.
     */
    const initialFrame =
      window.requestAnimationFrame(
        () => {
