...
const NAVIGATION_SR = [
  { label: "Početna", href: "/" },
  { label: "Projekti", href: "/serije" },
  { label: "Likovi", href: "/likovi" },
  { label: "Umbra", href: "/#manifesto" },
  { label: "Gledaj", href: "/#watch" },
] as const;

const NAVIGATION_EN = [
  { label: "Home", href: "/en" },
  { label: "Projects", href: "/en/projects" },
  { label: "Characters", href: "/en/characters" },
  { label: "Umbra", href: "/en#manifesto" },
  { label: "Watch", href: "/en#watch" },
] as const;
...
function InteractiveCredit({
  ...
  return (
    <a
      ...
      className="group block rounded-sm outline-none focus-visible:ring-1 focus-visible:ring-[#ead39a]/60"
    >
      <div className="mb-3 flex items-center justify-between">
        <span
          className="text-[6px] font-semibold uppercase tracking-[0.32em]"
          style={{ color: `${GOLD_LIGHT}54` }}
        >
          {copy.creditLabel}
        </span>
      ...
      >
        {!reducedMotion && (
          <motion.span
            ...
            style={{
              background: `radial-gradient(ellipse 360px 120px at 86% 50%, ${GOLD}08, transparent 72%)`,
            }}
          />
        )}
        ...
        {!reducedMotion && (
          <motion.span
            ...
            animate={
              active
                ? { x: "740%", opacity: [0, 0.8, 0] }
                : { x: "0%", opacity: 0 }
            }
            transition={{
              duration: active ? 0.72 : 0,
              ease: "easeInOut",
            }}
            style={{
              background: `linear-gradient(90deg, transparent, ${GOLD_LIGHT}28, ${GOLD_LIGHT}05, transparent)`,
              filter: "blur(3px)",
            }}
          />
        )}
        ...
        <motion.span
          ...
          whileInView={{ width: "22%", opacity: 0.68 }}
            ...
            >
              ...
              <div className="relative inline-block px-1 py-1">
                <span
                  ...
                  style={{ borderColor: `${GOLD_LIGHT}70` }}
                />
                <span
                  aria-hidden="true"
                ...
                <motion.span
                  ...
                  animate={{
                    color: active
                      ? GOLD_LIGHT
                      : "rgba(255,255,255,.38)",
                    letterSpacing: active ? "0.19em" : "0.17em",
                  }}
                  transition={{
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        <span
          className="text-[6px] uppercase tracking-[0.21em] transition-colors duration-300 group-hover:text-[#ead39a]/80"
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background: `radial-gradient(ellipse, ${GOLD}07 0%, transparent 72%)`,
            filter: "blur(82px)",
          }}
        />
          ...
          <div className="flex flex-col gap-9 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <motion.div
                ...
                style={{
                  background: `linear-gradient(90deg, ${GOLD_LIGHT}, ${GOLD}1e, transparent)`,
                }}
              />
            </div>
            ...
            <button
              ...
              onClick={scrollToTop}
              aria-label={copy.top}
              className="group flex w-fit items-center gap-3 text-[7px] uppercase tracking-[0.25em] text-white/[0.25] transition-colors duration-300 hover:text-[#ead39a] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#ead39a]/60"
            >
              <span>{copy.top}</span>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(90deg, transparent, ${GOLD}22, ${GOLD_LIGHT}10, transparent)`,
        }}
      />
    </footer>
  );
